...
//
//   let voteResponsModelSearch = try? JSONDecoder().decode(VoteResponsModelSearch.self, from: jsonData)

import Foundation

// MARK: - VoteResponsModelSearchElement
struct VoteResponsModelSearchElement: Codable {
    let weight: Weight
    let id, name: String
    let cfaURL: String?
...
typealias VoteResponsModelSearch = [VoteResponsModelSearchElement]

...
import 'package:tubes2_uas_kelompok2/data/breeds/datasource/breeds_datasource.dart';
import 'package:tubes2_uas_kelompok2/data/favorite/datasource/favorite_datasource.dart';
import 'package:tubes2_uas_kelompok2/data/favorite/requestsmodel/favorite_requests_model.dart';
...
void main() {
  group('Vote Datasource test', () {
    ...
    test('create Vote return correct data when successful', () async {
      ...
      final response = await voteDatasource.createVote(favoriteReqModel);
